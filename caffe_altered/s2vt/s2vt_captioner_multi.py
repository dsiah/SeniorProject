...
def main(num):
  ...
  # for each file use this pattern other patterns not working for now?
  currFileName = 'output_features_split{:02d}.csv'.format(num)

  FRAMEFEAT_FILE_PATTERN = '/home/dsiah/Documents/videos/food/ButternutSquashStuffedPastaBakeazydqgAwBE8/vgg_features_12x16/' + currFileName
