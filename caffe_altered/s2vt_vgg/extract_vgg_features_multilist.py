...
class FeatureExtractor():
  ...
  def set_image_batch_size(self, batch_size):
    ...
    print("Here Feture Extractor set image batch")
...
def compute_image_list_features(feature_extractor, images_file_path, out_file):
  ...
  print("Here Computer iMage list")

def main():
    # (TODO) Change this static range to correct range
  for i in xrange(1, 55):
    BASE_DIR = ''
    IMAGE_LIST_FILE = 'image_paths_split{:02d}'.format(i)
    IMAGE_PATH = '../images/cat.jpg'
    OUTPUT_FILE = 'output_features_split{:02d}.csv'.format(i)
    BATCH_SIZE = 10

    IMAGE_NET_FILE = './VGG_ILSVRC_16_layers_deploy.prototxt'
    MODEL_FILE = BASE_DIR + './VGG_ILSVRC_16_layers.caffemodel'
    DEVICE_ID = 0
  ...
  # BASE_DIR = ''
  # IMAGE_LIST_FILE = 'image_paths_list.txt'
  # IMAGE_PATH = '../images/cat.jpg'
